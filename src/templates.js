...
const LOCATION_HINTS = [
  ...
  { pattern: /\bnice\b/i, label: 'Nice, France' },
  ...
  { pattern: /\blisbon\b|\blisbonne\b/i, label: 'Lisbon, Portugal' },
  { pattern: /\bstockholm\b/i, label: 'Stockholm, Sweden' },
  { pattern: /\bcopenhagen\b|\bcopenhague\b/i, label: 'Copenhagen, Denmark' },
  { pattern: /\bzurich\b|\bzürich\b/i, label: 'Zurich, Switzerland' },
  { pattern: /\bgeneva\b|\bgenève\b/i, label: 'Geneva, Switzerland' },
  { pattern: /\brussels\b|\bbruxelles\b/i, label: 'Brussels, Belgium' },
  { pattern: /\bvienna\b|\bvienne\b/i, label: 'Vienna, Austria' },
  { pattern: /\bwarsaw\b|\bvarsovie\b/i, label: 'Warsaw, Poland' },
  { pattern: /\bpragué?\b/i, label: 'Prague, Czech Republic' },
  // Middle East
